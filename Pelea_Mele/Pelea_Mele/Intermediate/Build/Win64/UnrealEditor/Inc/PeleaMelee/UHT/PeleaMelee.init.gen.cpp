...
void EmptyLinkFunctionForGeneratedCodePeleaMelee_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_PeleaMelee()
	{
		if (!Z_Registration_Info_UPackage__Script_PeleaMelee.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_PeleaMelee_onDeathSignature__DelegateSignature,
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_PeleaMelee(Z_Construct_UPackage__Script_PeleaMelee, TEXT("/Script/PeleaMelee"), Z_Registration_Info_UPackage__Script_PeleaMelee, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x2CCA12B8, 0xAA1EEB1C));
